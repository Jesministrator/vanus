...
type SegmentServer_AppendToBlockStreamClient interface {
	Send(*AppendToBlockRequest) error
	Recv() (*AppendToBlockResponse, error)
	grpc.ClientStream
}
...
func (x *segmentServerAppendToBlockStreamClient) Send(m *AppendToBlockRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *segmentServerAppendToBlockStreamClient) Recv() (*AppendToBlockResponse, error) {
	m := new(AppendToBlockResponse)
...
type SegmentServer_ReadFromBlockStreamClient interface {
	Send(*ReadFromBlockRequest) error
	Recv() (*ReadFromBlockResponse, error)
	grpc.ClientStream
}
...
func (x *segmentServerReadFromBlockStreamClient) Send(m *ReadFromBlockRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *segmentServerReadFromBlockStreamClient) Recv() (*ReadFromBlockResponse, error) {
	m := new(ReadFromBlockResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type SegmentServer_AppendToBlockStreamServer interface {
	Send(*AppendToBlockResponse) error
	Recv() (*AppendToBlockRequest, error)
	grpc.ServerStream
}
...
func (x *segmentServerAppendToBlockStreamServer) Send(m *AppendToBlockResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *segmentServerAppendToBlockStreamServer) Recv() (*AppendToBlockRequest, error) {
	m := new(AppendToBlockRequest)
...
type SegmentServer_ReadFromBlockStreamServer interface {
	Send(*ReadFromBlockResponse) error
	Recv() (*ReadFromBlockRequest, error)
	grpc.ServerStream
}
...
func (x *segmentServerReadFromBlockStreamServer) Send(m *ReadFromBlockResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *segmentServerReadFromBlockStreamServer) Recv() (*ReadFromBlockRequest, error) {
	m := new(ReadFromBlockRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
